...
class CoreDevDebugProjectContainer extends \Thelia\Core\DependencyInjection\TheliaContainer
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'module.theliamigratecountry' => 'getModule_TheliamigratecountryService',
            ...
            'module.virtualproductdelivery' => 'getModule_VirtualproductdeliveryService',
            ...
            'router.theliamigratecountry' => 'getRouter_TheliamigratecountryService',
            ...
            'thelia.form.type.country.state.migrate' => 'getThelia_Form_Type_Country_State_MigrateService',
            ...
            'theliamigratecountry.action' => 'getTheliamigratecountry_ActionService',
            'theliamigratecountry.hook' => 'getTheliamigratecountry_HookService',
            ...
            'virtualproductdelivery.events' => 'getVirtualproductdelivery_EventsService',
            'virtualproductdelivery.hook' => 'getVirtualproductdelivery_HookService',
            'virtualproductdelivery.mail' => 'getVirtualproductdelivery_MailService',
        );
    ...
    protected function getCarousel_HookService()
    {
        ...
        $instance->addTemplate('hook.2.module.configuration.1', 'render:module_configuration.html');
        $instance->addTemplate('hook.2.module.config-js.1', 'js:assets/js/module-configuration.js');
    ...
    protected function getColissimo_HookService()
    {
        ...
        $instance->addTemplate('hook.2.module.config-js.2', 'render:assets/js/module-configuration-js.html');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('virtualproductdelivery.events', 'VirtualProductDelivery\\EventListeners\\VirtualProductEvents');
        $instance->addSubscriberService('virtualproductdelivery.mail', 'VirtualProductDelivery\\EventListeners\\SendMail');
        $instance->addSubscriberService('theliamigratecountry.action', 'TheliaMigrateCountry\\EventListeners\\MigrateCountryListener');
        $instance->addListenerService('hook.1.order-invoice.delivery-address.24', array(0 => 'virtualproductdelivery.hook', 1 => 'insertTemplate'), 999);
        ...
        $instance->addListenerService('hook.1.main.navbar-primary', array(0 => 'hooksearch.hook.front', 1 => 'insertTemplate'), 999);
        ...
        $instance->addListenerService('hook.1.home.body', array(0 => 'carousel.hook', 1 => 'insertTemplate'), 997);
        $instance->addListenerService('hook.1.account-order.after-products', array(0 => 'virtualproductdelivery.hook', 1 => 'onAccountOrderAfterProducts'), 999);
        $instance->addListenerService('hook.1.mini-cart', array(0 => 'hookcart.hook.front', 1 => 'insertTemplate'), 999);
        $instance->addListenerService('hook.2.configuration.shipping-bottom', array(0 => 'theliamigratecountry.hook', 1 => 'insertTemplate'), 999);
        ...
        $instance->addListenerService('hook.2.module.configuration.3', array(0 => 'cheque.hook', 1 => 'insertTemplate'), 997);
        $instance->addListenerService('hook.2.module.configuration.2', array(0 => 'colissimo.hook', 1 => 'onModuleConfiguration'), 996);
        $instance->addListenerService('hook.2.module.configuration.1', array(0 => 'carousel.hook', 1 => 'insertTemplate'), 995);
        $instance->addListenerService('hook.2.module.configuration.5', array(0 => 'tinymce.hook', 1 => 'insertTemplate'), 994);
        ...
        $instance->addListenerService('hook.2.module.config-js.2', array(0 => 'colissimo.hook', 1 => 'insertTemplate'), 997);
        $instance->addListenerService('hook.2.module.config-js.1', array(0 => 'carousel.hook', 1 => 'insertTemplate'), 996);
        $instance->addListenerService('hook.2.main.head-css', array(0 => 'hookadminhome.hook.css', 1 => 'insertTemplate'), 999);
        $instance->addListenerService('hook.2.main.top-menu-tools', array(0 => 'carousel.hook.back', 1 => 'onMainTopMenuTools'), 999);
        ...
        $instance->addListenerService('hook.3.invoice.delivery-address.24', array(0 => 'virtualproductdelivery.hook', 1 => 'insertTemplate'), 999);
        $instance->addListenerService('hook.3.delivery.delivery-address.24', array(0 => 'virtualproductdelivery.hook', 1 => 'insertTemplate'), 999);
    ...
    /**
     * Gets the 'module.freeorder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FreeOrder\FreeOrder A FreeOrder\FreeOrder instance.
     */
    ...
    /**
     * Gets the 'module.theliamigratecountry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TheliaMigrateCountry\TheliaMigrateCountry A TheliaMigrateCountry\TheliaMigrateCountry instance.
     */
    protected function getModule_TheliamigratecountryService()
    {
        $this->services['module.theliamigratecountry'] = $instance = new \TheliaMigrateCountry\TheliaMigrateCountry();
    ...
    /**
     * Gets the 'module.virtualproductdelivery' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VirtualProductDelivery\VirtualProductDelivery A VirtualProductDelivery\VirtualProductDelivery instance.
     */
    protected function getModule_VirtualproductdeliveryService()
    {
        $this->services['module.virtualproductdelivery'] = $instance = new \VirtualProductDelivery\VirtualProductDelivery();
    ...
    protected function getRouter_ChainrequestService()
    {
        ...
        $instance->add($this->get('router.carousel'), 150);
        $instance->add($this->get('router.colissimo'), 150);
        $instance->add($this->get('router.cheque'), 150);
        ...
        $instance->add($this->get('router.tinymce'), 150);
        $instance->add($this->get('router.hookadminhome'), 150);
        $instance->add($this->get('router.theliamigratecountry'), 150);
    ...
    /**
     * Gets the 'router.theliamigratecountry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Component\Routing\Router A Symfony\Component\Routing\Router instance.
     */
    protected function getRouter_TheliamigratecountryService()
    {
        return $this->services['router.theliamigratecountry'] = new \Symfony\Component\Routing\Router($this->get('router.module.xmlloader'), ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/Config/routing.xml'), array('cache_dir' => __DIR__, 'debug' => true, 'matcher_cache_class' => 'ProjectUrlMatcherTheliaMigrateCountry', 'generator_cache_class' => 'ProjectUrlGeneratorTheliaMigrateCountry'), $this->get('request.context'));
    }
    ...
    {
        return $this->services['smarty.plugin.dataaccess'] = new \TheliaSmarty\Template\Plugins\DataAccessFunctions($this->get('request_stack'), $this->get('thelia.securitycontext'), $this->get('thelia.taxengine'), $this->get('thelia.parser.context'), $this->get('event_dispatcher'));
    }
    ...
    /**
     * Gets the 'thelia.form.type.country.state.migrate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TheliaMigrateCountry\Form\Type\CountryStateMigrationType A TheliaMigrateCountry\Form\Type\CountryStateMigrationType instance.
     */
    protected function getThelia_Form_Type_Country_State_MigrateService()
    {
        return $this->services['thelia.form.type.country.state.migrate'] = new \TheliaMigrateCountry\Form\Type\CountryStateMigrationType();
    }
    ...
    {
        return $this->services['thelia.form_factory'] = new \Thelia\Core\Form\TheliaFormFactory($this->get('request_stack'), $this, array('thelia.front.customer.login' => 'Thelia\\Form\\CustomerLogin', 'thelia.front.customer.lostpassword' => 'Thelia\\Form\\CustomerLostPasswordForm', 'thelia.front.customer.create' => 'Thelia\\Form\\CustomerCreateForm', 'thelia.front.customer.profile.update' => 'Thelia\\Form\\CustomerProfileUpdateForm', 'thelia.front.customer.password.update' => 'Thelia\\Form\\CustomerPasswordUpdateForm', 'thelia.front.address.create' => 'Thelia\\Form\\AddressCreateForm', 'thelia.front.address.update' => 'Thelia\\Form\\AddressUpdateForm', 'thelia.front.contact' => 'Thelia\\Form\\ContactForm', 'thelia.front.newsletter' => 'Thelia\\Form\\NewsletterForm', 'thelia.front.newsletter.unsubscribe' => 'Thelia\\Form\\NewsletterUnsubscribeForm', 'thelia.admin.login' => 'Thelia\\Form\\AdminLogin', 'thelia.admin.lostpassword' => 'Thelia\\Form\\AdminLostPassword', 'thelia.admin.createpassword' => 'Thelia\\Form\\AdminCreatePassword', 'thelia.admin.seo' => 'Thelia\\Form\\SeoForm', 'thelia.admin.customer.create' => 'Thelia\\Form\\CustomerCreateForm', 'thelia.admin.customer.update' => 'Thelia\\Form\\CustomerUpdateForm', 'thelia.admin.address.create' => 'Thelia\\Form\\AddressCreateForm', 'thelia.admin.address.update' => 'Thelia\\Form\\AddressUpdateForm', 'thelia.admin.category.creation' => 'Thelia\\Form\\CategoryCreationForm', 'thelia.admin.category.modification' => 'Thelia\\Form\\CategoryModificationForm', 'thelia.admin.category.image.modification' => 'Thelia\\Form\\CategoryImageModification', 'thelia.admin.category.document.modification' => 'Thelia\\Form\\CategoryDocumentModification', 'thelia.admin.product.creation' => 'Thelia\\Form\\ProductCreationForm', 'thelia.admin.product.clone' => 'Thelia\\Form\\ProductCloneForm', 'thelia.admin.product.modification' => 'Thelia\\Form\\ProductModificationForm', 'thelia.admin.product.details.modification' => 'Thelia\\Form\\ProductDetailsModificationForm', 'thelia.admin.product.image.modification' => 'Thelia\\Form\\ProductImageModification', 'thelia.admin.product.document.modification' => 'Thelia\\Form\\ProductDocumentModification', 'thelia.admin.product_sale_element.update' => 'Thelia\\Form\\ProductSaleElementUpdateForm', 'thelia.admin.product_default_sale_element.update' => 'Thelia\\Form\\ProductDefaultSaleElementUpdateForm', 'thelia.admin.product_combination.build' => 'Thelia\\Form\\ProductCombinationGenerationForm', 'thelia.admin.product.deletion' => 'Thelia\\Form\\ProductModificationForm', 'thelia.admin.folder.creation' => 'Thelia\\Form\\FolderCreationForm', 'thelia.admin.folder.modification' => 'Thelia\\Form\\FolderModificationForm', 'thelia.admin.folder.image.modification' => 'Thelia\\Form\\FolderImageModification', 'thelia.admin.folder.document.modification' => 'Thelia\\Form\\FolderDocumentModification', 'thelia.admin.content.creation' => 'Thelia\\Form\\ContentCreationForm', 'thelia.admin.content.modification' => 'Thelia\\Form\\ContentModificationForm', 'thelia.admin.content.image.modification' => 'Thelia\\Form\\ContentImageModification', 'thelia.admin.content.document.modification' => 'Thelia\\Form\\ContentDocumentModification', 'thelia.admin.brand.creation' => 'Thelia\\Form\\Brand\\BrandCreationForm', 'thelia.admin.brand.modification' => 'Thelia\\Form\\Brand\\BrandModificationForm', 'thelia.admin.brand.image.modification' => 'Thelia\\Form\\Brand\\BrandImageModification', 'thelia.admin.brand.document.modification' => 'Thelia\\Form\\Brand\\BrandDocumentModification', 'thelia.cart.add' => 'Thelia\\Form\\CartAdd', 'thelia.order.delivery' => 'Thelia\\Form\\OrderDelivery', 'thelia.order.payment' => 'Thelia\\Form\\OrderPayment', 'thelia.order.update.address' => 'Thelia\\Form\\OrderUpdateAddress', 'thelia.order.coupon' => 'Thelia\\Form\\CouponCode', 'thelia.admin.config.creation' => 'Thelia\\Form\\ConfigCreationForm', 'thelia.admin.config.modification' => 'Thelia\\Form\\ConfigModificationForm', 'thelia.admin.message.creation' => 'Thelia\\Form\\MessageCreationForm', 'thelia.admin.message.modification' => 'Thelia\\Form\\MessageModificationForm', 'thelia.admin.currency.creation' => 'Thelia\\Form\\CurrencyCreationForm', 'thelia.admin.currency.modification' => 'Thelia\\Form\\CurrencyModificationForm', 'thelia.admin.coupon.creation' => 'Thelia\\Form\\CouponCreationForm', 'thelia.admin.attribute.creation' => 'Thelia\\Form\\AttributeCreationForm', 'thelia.admin.attribute.modification' => 'Thelia\\Form\\AttributeModificationForm', 'thelia.admin.feature.creation' => 'Thelia\\Form\\FeatureCreationForm', 'thelia.admin.feature.modification' => 'Thelia\\Form\\FeatureModificationForm', 'thelia.admin.attributeav.creation' => 'Thelia\\Form\\AttributeAvCreationForm', 'thelia.admin.attributeav.modification' => 'Thelia\\Form\\AttributeAvCreationForm', 'thelia.admin.featureav.creation' => 'Thelia\\Form\\FeatureAvCreationForm', 'thelia.admin.taxrule.modification' => 'Thelia\\Form\\TaxRuleModificationForm', 'thelia.admin.taxrule.taxlistupdate' => 'Thelia\\Form\\TaxRuleTaxListUpdateForm', 'thelia.admin.taxrule.add' => 'Thelia\\Form\\TaxRuleCreationForm', 'thelia.admin.tax.modification' => 'Thelia\\Form\\TaxModificationForm', 'thelia.admin.tax.taxlistupdate' => 'Thelia\\Form\\TaxTaxListUpdateForm', 'thelia.admin.tax.add' => 'Thelia\\Form\\TaxCreationForm', 'thelia.admin.profile.add' => 'Thelia\\Form\\ProfileCreationForm', 'thelia.admin.profile.modification' => 'Thelia\\Form\\ProfileModificationForm', 'thelia.admin.profile.resource-access.modification' => 'Thelia\\Form\\ProfileUpdateResourceAccessForm', 'thelia.admin.profile.module-access.modification' => 'Thelia\\Form\\ProfileUpdateModuleAccessForm', 'thelia.admin.administrator.add' => 'Thelia\\Form\\AdministratorCreationForm', 'thelia.admin.administrator.update' => 'Thelia\\Form\\AdministratorModificationForm', 'thelia.admin.mailing-system.update' => 'Thelia\\Form\\MailingSystemModificationForm', 'thelia.admin.template.creation' => 'Thelia\\Form\\TemplateCreationForm', 'thelia.admin.template.modification' => 'Thelia\\Form\\TemplateModificationForm', 'thelia.admin.country.creation' => 'Thelia\\Form\\CountryCreationForm', 'thelia.admin.country.modification' => 'Thelia\\Form\\CountryModificationForm', 'thelia.admin.state.creation' => 'Thelia\\Form\\State\\StateCreationForm', 'thelia.admin.state.modification' => 'Thelia\\Form\\State\\StateModificationForm', 'thelia.admin.area.create' => 'Thelia\\Form\\Area\\AreaCreateForm', 'thelia.admin.area.modification' => 'Thelia\\Form\\Area\\AreaModificationForm', 'thelia.admin.area.country' => 'Thelia\\Form\\Area\\AreaCountryForm', 'thelia.admin.area.delete.country' => 'Thelia\\Form\\Area\\AreaDeleteCountryForm', 'thelia.admin.area.postage' => 'Thelia\\Form\\Area\\AreaPostageForm', 'thelia.shopping_zone_area' => 'Thelia\\Form\\ShippingZone\\ShippingZoneAddArea', 'thelia.shipping_zone_area' => 'Thelia\\Form\\ShippingZone\\ShippingZoneAddArea', 'thelia.shopping_zone_remove_area' => 'Thelia\\Form\\ShippingZone\\ShippingZoneRemoveArea', 'thelia.lang.update' => 'Thelia\\Form\\Lang\\LangUpdateForm', 'thelia.lang.create' => 'Thelia\\Form\\Lang\\LangCreateForm', 'thelia.lang.defaultBehavior' => 'Thelia\\Form\\Lang\\LangDefaultBehaviorForm', 'thelia.lang.url' => 'Thelia\\Form\\Lang\\LangUrlForm', 'thelia.configuration.store' => 'Thelia\\Form\\ConfigStoreForm', 'thelia.system-logs.configuration' => 'Thelia\\Form\\SystemLogConfigurationForm', 'thelia.admin.module.modification' => 'Thelia\\Form\\ModuleModificationForm', 'thelia.admin.module.image.modification' => 'Thelia\\Form\\ModuleImageModification', 'thelia.admin.module.install' => 'Thelia\\Form\\ModuleInstallForm', 'thelia.admin.hook.creation' => 'Thelia\\Form\\HookCreationForm', 'thelia.admin.hook.modification' => 'Thelia\\Form\\HookModificationForm', 'thelia.admin.module-hook.creation' => 'Thelia\\Form\\ModuleHookCreationForm', 'thelia.admin.module-hook.modification' => 'Thelia\\Form\\ModuleHookModificationForm', 'thelia.cache.flush' => 'Thelia\\Form\\Cache\\CacheFlushForm', 'thelia.assets.flush' => 'Thelia\\Form\\Cache\\AssetsFlushForm', 'thelia.images-and-documents-cache.flush' => 'Thelia\\Form\\Cache\\ImagesAndDocumentsCacheFlushForm', 'thelia.export' => 'Thelia\\Form\\ExportForm', 'thelia.import' => 'Thelia\\Form\\ImportForm', 'thelia.admin.sale.creation' => 'Thelia\\Form\\Sale\\SaleCreationForm', 'thelia.admin.sale.modification' => 'Thelia\\Form\\Sale\\SaleModificationForm', 'thelia.empty' => 'Thelia\\Form\\EmptyForm', 'thelia_api_create' => 'Thelia\\Form\\Api\\ApiCreateForm', 'thelia_api_update' => 'Thelia\\Form\\Api\\ApiUpdateForm', 'thelia.api.empty' => 'Thelia\\Form\\Api\\ApiEmptyForm', 'thelia.api.customer.create' => 'Thelia\\Form\\Api\\Customer\\CustomerCreateForm', 'thelia.api.customer.update' => 'Thelia\\Form\\Api\\Customer\\CustomerUpdateForm', 'thelia.api.customer.login' => 'Thelia\\Form\\Api\\Customer\\CustomerLogin', 'thelia.api.category.create' => 'Thelia\\Form\\Api\\Category\\CategoryCreationForm', 'thelia.api.category.update' => 'Thelia\\Form\\Api\\Category\\CategoryModificationForm', 'thelia.api.product_sale_elements' => 'Thelia\\Form\\Api\\ProductSaleElements\\ProductSaleElementsForm', 'thelia.api.product.creation' => 'Thelia\\Form\\Api\\Product\\ProductCreationForm', 'thelia.api.product.modification' => 'Thelia\\Form\\Api\\Product\\ProductModificationForm', 'carousel.image' => 'Carousel\\Form\\CarouselImageForm', 'carousel.update' => 'Carousel\\Form\\CarouselUpdateForm', 'colissimo.freeshipping.form' => 'Colissimo\\Form\\FreeShipping', 'colissimo.export.form' => 'Colissimo\\Form\\Export', 'colissimo.configuration' => 'Colissimo\\Form\\Configuration', 'cheque.instructions.configure' => 'Cheque\\Form\\ConfigurationForm', 'hookanalytics.configuration.form' => 'HookAnalytics\\Form\\Configuration', 'hooknavigation.configuration' => 'HookNavigation\\Form\\HookNavigationConfigForm', 'hooksocial.configuration.form' => 'HookSocial\\Form\\Configuration', 'tinymce.configure' => 'Tinymce\\Form\\ConfigurationForm', 'thelia.admin.country.state.migration' => 'TheliaMigrateCountry\\Form\\CountryStateMigrationForm'));
    }
    ...
    protected function getThelia_FormFactoryBuilderService()
    {
        ...
        $instance->addType($this->get('thelia.form.type.country.state.migrate'));
    ...
    protected function getThelia_ParserService()
    {
        ...
        $instance->addTemplateDirectory(1, 'default', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/templates/frontOffice/default'), 'VirtualProductDelivery');
        $instance->addTemplateDirectory(3, 'default', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/templates/pdf/default'), 'VirtualProductDelivery');
        $instance->addTemplateDirectory(4, 'default', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/templates/email/default'), 'VirtualProductDelivery');
        ...
        $instance->addTemplateDirectory(2, 'default', ($this->targetDirs[2].'/local/modules/HookAnalytics/templates/backOffice/default'), 'HookAnalytics');
        ...
        $instance->addTemplateDirectory(2, 'default', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/templates/backOffice/default'), 'TheliaMigrateCountry');
    ...
    protected function getThelia_TranslatorService()
    {
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/tr_TR.php'), 'tr_TR', 'virtualproductdelivery');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/fr_FR.php'), 'fr_FR', 'virtualproductdelivery');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/en_US.php'), 'en_US', 'virtualproductdelivery');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/de_DE.php'), 'de_DE', 'virtualproductdelivery');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/it_IT.php'), 'it_IT', 'virtualproductdelivery');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/frontOffice/default/tr_TR.php'), 'tr_TR', 'virtualproductdelivery.fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/frontOffice/default/fr_FR.php'), 'fr_FR', 'virtualproductdelivery.fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/frontOffice/default/en_US.php'), 'en_US', 'virtualproductdelivery.fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/frontOffice/default/de_DE.php'), 'de_DE', 'virtualproductdelivery.fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/frontOffice/default/it_IT.php'), 'it_IT', 'virtualproductdelivery.fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/pdf/default/tr_TR.php'), 'tr_TR', 'virtualproductdelivery.pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/pdf/default/fr_FR.php'), 'fr_FR', 'virtualproductdelivery.pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/pdf/default/en_US.php'), 'en_US', 'virtualproductdelivery.pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/pdf/default/de_DE.php'), 'de_DE', 'virtualproductdelivery.pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/pdf/default/it_IT.php'), 'it_IT', 'virtualproductdelivery.pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/email/default/tr_TR.php'), 'tr_TR', 'virtualproductdelivery.email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/email/default/fr_FR.php'), 'fr_FR', 'virtualproductdelivery.email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/email/default/en_US.php'), 'en_US', 'virtualproductdelivery.email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/VirtualProductDelivery/I18n/email/default/it_IT.php'), 'it_IT', 'virtualproductdelivery.email.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/HookAnalytics/I18n/backOffice/default/tr_TR.php'), 'tr_TR', 'hookanalytics.bo.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/fr_FR.php'), 'fr_FR', 'theliamigratecountry');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/en_US.php'), 'en_US', 'theliamigratecountry');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/it_IT.php'), 'it_IT', 'theliamigratecountry');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/backOffice/default/fr_FR.php'), 'fr_FR', 'theliamigratecountry.bo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/backOffice/default/en_US.php'), 'en_US', 'theliamigratecountry.bo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/local/modules/TheliaMigrateCountry/I18n/backOffice/default/it_IT.php'), 'it_IT', 'theliamigratecountry.bo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/ar_SA.php'), 'ar_SA', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/fa_IR.php'), 'fa_IR', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/pt_PT.php'), 'pt_PT', 'core');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/pt_BR.php'), 'pt_BR', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/pl_PL.php'), 'pl_PL', 'core');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/hu_HU.php'), 'hu_HU', 'core');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/sk_SK.php'), 'sk_SK', 'core');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/ro_RO.php'), 'ro_RO', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/uk_UA.php'), 'uk_UA', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/ru_RU.php'), 'ru_RU', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/he_IL.php'), 'he_IL', 'core');
        $instance->addResource('php', ($this->targetDirs[2].'/vendor/thelia/core/lib/Thelia/Config/I18n/zh_CN.php'), 'zh_CN', 'core');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/fa_IR.php'), 'fa_IR', 'fo.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/pt_BR.php'), 'pt_BR', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/pl_PL.php'), 'pl_PL', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/es_ES.php'), 'es_ES', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/nl_NL.php'), 'nl_NL', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/cs_CZ.php'), 'cs_CZ', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/hu_HU.php'), 'hu_HU', 'fo.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/sk_SK.php'), 'sk_SK', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/de_DE.php'), 'de_DE', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/id_ID.php'), 'id_ID', 'fo.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/frontOffice/default/I18n/uk_UA.php'), 'uk_UA', 'fo.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/fa_IR.php'), 'fa_IR', 'pdf.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/pt_BR.php'), 'pt_BR', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/pl_PL.php'), 'pl_PL', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/es_ES.php'), 'es_ES', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/nl_NL.php'), 'nl_NL', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/cs_CZ.php'), 'cs_CZ', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/hu_HU.php'), 'hu_HU', 'pdf.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/sk_SK.php'), 'sk_SK', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/de_DE.php'), 'de_DE', 'pdf.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/pdf/default/I18n/id_ID.php'), 'id_ID', 'pdf.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/fa_IR.php'), 'fa_IR', 'email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/pt_PT.php'), 'pt_PT', 'email.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/pt_BR.php'), 'pt_BR', 'email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/pl_PL.php'), 'pl_PL', 'email.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/hu_HU.php'), 'hu_HU', 'email.default');
        ...
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/sk_SK.php'), 'sk_SK', 'email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/de_DE.php'), 'de_DE', 'email.default');
        $instance->addResource('php', ($this->targetDirs[2].'/templates/email/default/I18n/id_ID.php'), 'id_ID', 'email.default');
    ...
    /**
     * Gets the 'theliamigratecountry.action' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TheliaMigrateCountry\EventListeners\MigrateCountryListener A TheliaMigrateCountry\EventListeners\MigrateCountryListener instance.
     */
    protected function getTheliamigratecountry_ActionService()
    {
        return $this->services['theliamigratecountry.action'] = new \TheliaMigrateCountry\EventListeners\MigrateCountryListener();
    }

    /**
     * Gets the 'theliamigratecountry.hook' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Thelia\Core\Hook\DefaultHook A Thelia\Core\Hook\DefaultHook instance.
     */
    protected function getTheliamigratecountry_HookService()
    {
        $this->services['theliamigratecountry.hook'] = $instance = new \Thelia\Core\Hook\DefaultHook();

        $instance->addTemplate('hook.2.configuration.shipping-bottom', 'configuration-shipping-bottom.html');
        $instance->module = $this->get('module.theliamigratecountry');
        $instance->parser = $this->get('thelia.parser');
        $instance->translator = $this->get('thelia.translator');
        $instance->assetsResolver = $this->get('thelia.parser.asset.resolver');
        $instance->dispatcher = $this->get('event_dispatcher');
    ...
    protected function getTinymce_HookService()
    {
        ...
        $instance->addTemplate('hook.2.module.configuration.5', 'render:module_configuration.html');
    ...
    /**
     * Gets the 'virtualproductdelivery.events' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VirtualProductDelivery\EventListeners\VirtualProductEvents A VirtualProductDelivery\EventListeners\VirtualProductEvents instance.
     */
    protected function getVirtualproductdelivery_EventsService()
    {
        return $this->services['virtualproductdelivery.events'] = new \VirtualProductDelivery\EventListeners\VirtualProductEvents();
    }

    /**
     * Gets the 'virtualproductdelivery.hook' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VirtualProductDelivery\Hook\HookManager A VirtualProductDelivery\Hook\HookManager instance.
     */
    protected function getVirtualproductdelivery_HookService()
    {
        $this->services['virtualproductdelivery.hook'] = $instance = new \VirtualProductDelivery\Hook\HookManager();

        $instance->addTemplate('hook.1.order-invoice.delivery-address.24', 'render:delivery-address.html');
        $instance->addTemplate('hook.3.invoice.delivery-address.24', 'render:delivery-address.html');
        $instance->addTemplate('hook.3.delivery.delivery-address.24', 'render:delivery-address.html');
        $instance->module = $this->get('module.virtualproductdelivery');
        $instance->parser = $this->get('thelia.parser');
        $instance->translator = $this->get('thelia.translator');
        $instance->assetsResolver = $this->get('thelia.parser.asset.resolver');
        $instance->dispatcher = $this->get('event_dispatcher');
    ...
    /**
     * Gets the 'virtualproductdelivery.mail' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VirtualProductDelivery\EventListeners\SendMail A VirtualProductDelivery\EventListeners\SendMail instance.
     */
    protected function getVirtualproductdelivery_MailService()
    {
        return $this->services['virtualproductdelivery.mail'] = new \VirtualProductDelivery\EventListeners\SendMail($this->get('mailer'), $this->get('event_dispatcher'));
    }
